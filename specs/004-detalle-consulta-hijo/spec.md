...
- **FR-010**: El horario de inicio de cada medicamento es **obligatorio** al registrar la consulta *(cambio del 2026-09-20, spec 007: como una consulta es inmutable, un horario omitido no se podría completar después, y sin él no hay tomas ni tratamiento activo)*. Las consultas guardadas antes de este cambio pueden tener un medicamento sin horario: para ellas el sistema NO genera ningún registro individual de toma (solo se muestran su frecuencia y duración).
