...
- [x] **T014** Revisión página por página (2026-09-20): registro web (11) y móvil (01), detalle del hijo móvil (02) detalle de consulta móvil (03) y nueva consulta móvil (04) y pop-up del plan gratuito móvil (05); E2E propios (`detalle-hijo-movil.spec.ts`, `detalle-consulta-movil.spec.ts`, `nueva-consulta-movil.spec.ts`, `modal-plan-gratuito-movil.spec.ts`).
